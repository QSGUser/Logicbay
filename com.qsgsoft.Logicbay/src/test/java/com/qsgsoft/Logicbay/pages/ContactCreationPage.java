...
public class ContactCreationPage extends WaitForElement{
	...
	public void createContactinNmhg(WebDriver driver,String emailAddress,String firstName,String lastName,String Password,String TimeZone,String Locale,String MemberStatus,String SystemRole,String JobRole,String JobTitle) throws Exception{
	...
	public void enterusername(WebDriver driver,String username) throws Exception{
		driver.findElement(By.cssSelector(usernamefield)).clear();
		driver.findElement(By.cssSelector(usernamefield)).sendKeys(username);
		assertEquals(username, driver.findElement(By.cssSelector(usernamefield)).getAttribute("value"));
	}
	public void enterConfirmUsername(WebDriver driver,String confirmUsername) throws Exception{
		driver.findElement(By.cssSelector(confirmUsernamefield)).clear();
		driver.findElement(By.cssSelector(confirmUsernamefield)).sendKeys(confirmUsername);
		assertEquals(confirmUsername, driver.findElement(By.cssSelector(confirmUsernamefield)).getAttribute("value"));
	}
	...
	public void selectSave(WebDriver driver) throws Exception{
		assertTrue(isElementPresent(By.id(savebutton), driver));
